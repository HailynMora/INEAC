       ...
       <div class="container">
              <table class="table">
                  ...
                  <!-- Button trigger modal -->
                        ...
                        <a type="button" data-toggle="modal" data-target="#listaModalT{{$d->id}}" title="Lista de Objetivos">
                    ...
                    <!--modal visualizar objetivos-->
                        ...
                        <div class="modal fade" id="listaModalT{{$d->id}}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
