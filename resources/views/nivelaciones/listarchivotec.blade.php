	...
	<table class="table">
	  ...
	  <tbody style="background-color:#e3e3e3;" class="letraf">
	    ...
	    <td>{{$m->numrecibo}}</td>
          ...
          <!-- Modal -->
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <!--formulario-->
						<form action="{{route('reciboactualizartec')}}" method="POST" enctype="multipart/form-data">
							@csrf
          ...
          <td>
            <a type="button" data-toggle="modal" data-target="#confirtec{{$m->idniv}}" title="Eliminar datos"><i class="fas fa-trash-alt" style="color:red; font-size:24px;"></i></a>
            <!--modal-->
                <div class="modal fade" id="confirtec{{$m->idniv}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-warning" data-dismiss="modal">Salir</button>
                        <a href="/archivo/estudiante/elim/tec/{{$m->idniv}}" type="button" class="btn btn-primary">Confirmar</a>
                    </div>
                    </div>
                </div>
                </div>
