                    ...
                    <table class="table">
                        ...
                        <tbody style="background-color:#e3e3e3;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <!--aqui modal de reporte de notas-->
                                    <a type="button" class="btn" data-toggle="modal" data-target="#modalnotastec{{$ma->idtec}}">
                                        <i class="fas fa-file-excel fa-lg" style="color:blue;font-size: 25px;"></i>
                                    </a>
                                    <form action="{{route('filtrarNotasTec')}}" id="formudatos" method="post">
                                    @csrf
                                    <!-- Modal -->
                                        <div class="modal fade" id="modalnotastec{{$ma->idtec}}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header" style="background-color:#FFC107; color:white;">
                                                        <h5 class="modal-title" id="staticBackdropLabel">Seleccione el año y el periodo académico</h5>
